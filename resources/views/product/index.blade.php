                ...
                <div class="btn-group text-left">
                    <div class="btn-group btn-group-sm dropdown">
                        ...
                        <ul class="dropdown-menu" id="input-sort">
                            <li class="active"><a href="/product/select/default/DESC" rel="nofollow">По умолчанию</a></li>
                            <li><a href="/product/select/title/ASC" rel="nofollow">Название (А - Я)</a></li>
                            <li><a href="/product/select/title/DESC" rel="nofollow">Название (Я - А)</a></li>
                            <li><a href="/product/select/price/ASC" rel="nofollow">Цена (низкая &gt; высокая)</a></li>
                            <li><a href="/product/select/price/DESC" rel="nofollow">Цена (высокая &gt; низкая)</a></li>
                            <li><a href="/product/select/rating/ASC" rel="nofollow">Рейтинг (начиная с высокого)</a></li>
                            <li><a href="/product/select/rating/DESC" rel="nofollow">Рейтинг (начиная с низкого)</a></li>
                            <li><a href="/product/select/alias/ASC" rel="nofollow">Модель (А - Я)</a></li>
                            <li><a href="/product/select/alias/DESC" rel="nofollow">Модель (Я - А)</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="btn-group btn-group-sm limit-btn-group dropdown">
                        <ul class="dropdown-menu" id="input-limit" style="margin-left: -51px;">
                            <li><a href="/product/select/count/25" rel="nofollow">
                                    <small>25</small>
                                </a></li>
                            <li><a href="/product/select/count/50" rel="nofollow">
                                    <small>50</small>
                                </a></li>
                            <li class="active"><a href="/product/select/count/60" rel="nofollow">
                                    <small>60</small>
                                </a></li>
                            <li><a href="/product/select/count/75" rel="nofollow">
                                    <small>75</small>
                                </a></li>
                            <li><a href="/product/select/count/100" rel="nofollow">
                                    <small>100</small>
                                </a></li>
                        </ul>
                        <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
