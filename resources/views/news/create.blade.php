...
@section('content')
    ...
    <form action="/moderator/news/store" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset> {{csrf_field()}}
            <legend>добавить новость или акцию</legend>
            ...
            <div class="form-group required">
                ...
                <div class="col-md-8 col-sm-10">
                    <textarea name="body" rows="1" id="input-body" class="form-control"></textarea>
                </div>
            </div>
            <div class="form-group required">
